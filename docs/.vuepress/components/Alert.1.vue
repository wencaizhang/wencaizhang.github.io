<template>
  <section>
    ...
    <div class="msg" :class="message.status" v-show="message.show">
      <div class="msg--main">
        <i class="msg--icon" :class="message.type"></i>
        <div class="msg--tip">{{ message.text }}</div>
      </div>
    </div>
  </section>
</template>
...
export default {
  ...
  methods: {
    Alert: function(text, type, duration) {
      const vm = this;
      vm.message.status = "";
      clearTimeout(vm.timeout);
      vm.message.text = String(text);
      vm.message.duration = this.duration;
      vm.message.type = "msg--" + (type ? type : "info");
