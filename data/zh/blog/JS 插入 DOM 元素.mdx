...
tags: []
cover: ["https://static.webjam.cn/images/logos/js.svg", "https://static.webjam.cn/images/logos/html.svg"]
---
...
不过后来我发现原生的 JS 里面也有类似的方法: [element.insertAdjacentHTML - Web API 接口参考 | MDN (mozilla.org)](https://developer.mozilla.org/zh-CN/docs/Web/API/Element/insertAdjacentHTML)
